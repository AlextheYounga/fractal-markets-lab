...
def rangeRules(ticker):
    ...
    highs = list(reversed(removeZeroes(extractData(assetData, 'high'))))
    lows = list(reversed(removeZeroes(extractData(assetData, 'low'))))
    dates = list(reversed(removeZeroes(extractData(assetData, 'date'))))
    volumes = list(reversed(removeZeroes(extractData(assetData, 'volume'))))
